...
Output: 6
Explanation: The boy can buy all 6 ice cream bars for a total price of 18.
"""
...
assert maxIceCream([1,3,2,4,1], 7) == 4
assert maxIceCream([10,6,8,7,7,8], 5) == 0
assert maxIceCream([1,6,3,1,2,5], 20) == 6
